...
class FadCard extends Component {
  render() {
      return (
        <div>
          <NavBar />
              ...
              <div class="card">
                ...
                <div class="card__side card__side--back card__side--back-1">
                  <div class="card__description">
                    ...
                    office in 1978. The doll brand was one of the most
                    popular toy fads of the 1980s and one of the
                    longest-running doll franchises in the United States.
                    }
                  </div>
                </div>
              </div>
